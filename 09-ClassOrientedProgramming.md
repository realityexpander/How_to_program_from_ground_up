...
###### inheritance
  ...
  - "Subtyping," "Subclassing," and "Inheritance" are all the same concept, and the basis for "polymorphism."
    ...
    class MP3 {
       constructor MP3(String name) ➡︎ super(name + ".mp3")
       override method play() print "Playing MP3: " + this.name
    }
    class Video {
       constructor Video(String name) ➡︎ super(name + ".mp4")
    ...
    class ProtectedMP3 {
       ...
       constructor ProtectedMP3(String name, String password) ➡︎ super(name)
